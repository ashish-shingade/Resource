...
const handleadd = (e,id) =>{
  ...
  return (
    ...
    <div className='container profile-container'>
      <div className='labassistant-bg-box'>
      </div>
      ...
      <div className='row'>
        ...
        <div className="card profilecards slots">
          ...
          {(res.today_slots.length!==0)?<div></div>:
          <div className="container">
          <h1 className='reco-heading' style={{textAlign: "center", fontWeight : "bold"}}>No slots booked today</h1>
          </div>
        }
    ...
    <article class="labwf__profile ">
      ...
      <span class="slottime">{res.today_names[index].resource_name}</span><br></br>
        ...
        <div className="card profilecards workforce-list">
            ...
            {(res.tomorrow_slots.length!==0)?<div></div>:
          <div className="container">
          <h1 className='reco-heading' style={{textAlign: "center", fontWeight : "bold"}}>No slots booked tommorow</h1>
          </div>
        }
      ...
      <div className="row">
        ...
        {/* Labs  */}
        <p className='heading'><h3 class="heading_name" style={{marginTop: "20px"}}>Labs Managed By You</h3></p>
        <div className="row">
        ...
        <div className="d-flex justify-content-center" style={{marginDown: "20px"}}>
        {/* <Button variant="text">Show More</Button> */}
